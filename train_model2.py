...
def main() -> None:
    ...
    if use_per_class_gate and num_pt_statcast > 0 and len(cat_cols) > 0:
        ...
        print("ERROR: Production model requires --use_per_class_gate_logit flag and pitchtype statcast v2 cols.")
        print(f"  use_per_class_gate={use_per_class_gate}, num_pt_statcast={num_pt_statcast}, cat_cols={len(cat_cols)}")
        sys.exit(1)
    ...
    if _args.use_pitchtype_statcast_v2:
